...
def clicked1():
    ...
    if(current_value=='Sum of Array'):
        Flag=1
        current_value=r"D:\downloads\CA\CS204-Project\test\sumArray.mc"
    elif(current_value=='Fibbonaci Series'):
        Flag=1
        current_value=r"D:\downloads\CA\CS204-Project\test\fibbo.mc"
    else:
        Flag=1
        current_value=r"D:\downloads\CA\CS204-Project\test\bubbleSort.mc"
...
def clicked2():
    ...
    lb3.place(x=150, y=0)
    with open(r"D:\downloads\CA\CS204-Project\reg_out.mc",'r') as f:
...
def clicked3():
    ...
    lb3.place(x=150, y=0)
    with open(r"D:\downloads\CA\CS204-Project\data_out.mc",'r') as f:
...
img= (Image.open(r"D:\downloads\CA\CS204-Project\src\img3.png"))
